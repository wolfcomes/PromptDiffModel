...
pdb_file_ligand = '/data/home/zhangzhiyong/lead_optimization/PromptDiffModel/data/test_sdf_dataset/43f7d870_source.pdb'
...
checkpoint = torch.load('../checkpoints/zinc/cddpm_ligand_only_epoch_50.pth')
