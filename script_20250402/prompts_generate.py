...
def load_and_compare_admet():
    # 读取两个CSV文件
    df1 = pd.read_csv('../data/optimized_ligand/modified_smiles_preds.csv')
    df2 = pd.read_csv('../data/optimized_ligand/original_smiles_preds.csv')
    ...
    # 保存为CSV文件
    output_path = '../data/optimized_ligand/admet_comparison_prompts.csv'
